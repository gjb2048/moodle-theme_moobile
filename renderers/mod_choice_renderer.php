...
/**
 * Choice renderer for the moobile theme.
 *
 * @package    theme.
 ...
 * @copyright  Mary Evans original MyMobile theme.
 * @copyright  John Stabinger original MyMobile theme.
 * @author     G J Barnard - gjbarnard at gmail dot com and {@link http://moodle.org/user/profile.php?id=442195}.
 * @author     Based on code originally written by John Stabinger / Mary Evans.
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later.
 */

include_once ($CFG->dirroot. '/mod/choice/renderer.php');

class theme_moobile_mod_choice_renderer extends mod_choice_renderer {
